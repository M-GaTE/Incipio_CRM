...
/**
 * Class SiajeProspectImporter
 * @package mgate\PubliBundle\Manager
 * Service that imports prospect from a full siaje export.
 */
class SiajeProspectImporter extends CsvImporter implements FileImporterInterface
{
